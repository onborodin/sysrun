...
export class VmStop extends Component {
    ...
    @autobind
    showForm() {
        $("#stop-vm-" + this.props.vmId).modal('show')
    }

    @autobind
    hideForm() {
        $("#stop-vm-" + this.props.vmId).modal('hide')
    }

    @autobind
    stopVm() {
        axios.post('/api/v1/vm/stop', {
                id: this.props.vmId,
        }).then((res) => {
    ...
    @autobind
    makeId(base) {
        return 'vm-stop-' + base + '-' + this.props.vmId
    }
    ...
    render() {
        return (
            <Fragment>
                ...
                <i className="fas fa-stop" onClick={this.showForm}></i>

                <div className="modal fade" id={"stop-vm-" + this.props.vmId} tabIndex="-1" role="dialog"  ref="form">
                        ...
                        <div className="modal-content">
                            ...
                            <form acceptCharset="UTF-8" onSubmit={this.onSubmit} ref="form">
                                ...
                                <div className="modal-header">
                                    <h5 className="modal-title">Stop vm [{this.props.vm.name}]</h5>
                                ...
                                <div className="modal-footer">
                                    ...
                                    <button type="submit" className={this.state.formIsValid ? "btn btn-sm btn-primary" : "btn btn-sm btn-primary disabled"} onClick={this.onSubmit}>Stop</button>
                                </div>
