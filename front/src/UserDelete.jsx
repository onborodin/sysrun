...
export class UserDelete extends Component {
    ...
    @autobind
    showForm() {
        $("#delete-user-" + this.props.userId).modal('show')
    }

    @autobind
    hideForm() {
        $("#delete-user-" + this.props.userId).modal('hide')
    }
    ...
    @autobind
    makeId(base) {
        return 'user-delete-' + base + '-' + this.props.userId
    }
    ...
    render() {
        return (
            <Fragment>
                    ...
                    <i className="far fa-trash-alt" onClick={this.showForm}></i>

                <div className="modal fade" id={"delete-user-" + this.props.userId} tabIndex="-1" role="dialog"  ref="form">
